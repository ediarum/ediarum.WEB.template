...
(:
 ...
 : templating.
 :)
import module namespace config="http://www.bbaw.de/telota/software/ediarum/WEB" at "config.xqm";
import module namespace app="http://www.telota.de/templates" at "app.xql";
