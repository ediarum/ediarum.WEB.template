...
declare %templates:wrap function config:short-title($node as node(), $model as map(*)) {
    $config:expath-descriptor/@abbrev/string()
};

declare variable $config:base-url := substring-before(request:get-uri(), request:get-attribute("$exist:controller"))||request:get-attribute("$exist:controller");
